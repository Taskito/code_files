...
import 'package:taskito/views/widgets/splash.dart/opening_screen.dart';
// Import your SecondSlider screen
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            child: Image.asset(
              'assets/images/main_top.png', // Top corner image
              width:
          ...
          Center(
            child: Column(
              ...
              children: [
                // Center Image
                Image.asset(
                  'assets/images/registration two (1).png', // Center image
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      "Task It,\nTo Everyon", // Split text into two lines
                      style: TextStyle(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                      'assets/images/fisrt_slider-removebg-preview.png', // Slider icon
